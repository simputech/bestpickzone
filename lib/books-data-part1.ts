...
export const articlesData: ArticleData[] = [
  ...
  },
  {
    ...
    relatedSlugs: ["best-books-on-psychology", "best-self-help-books", "best-science-books-for-non-scientists"],
  },
  {
  ...
  },
  {
    ...
    verdict: "The Firm remains the cleanest Grisham recommendation because it is the book least likely to disappoint a first-time reader. Follow it with A Time to Kill if you want the richer, more serious version of what he can do, or jump to The Pelican Brief if pace is all you care about.",
    metadataKeywords: [
      "best john grisham books",
      "john grisham books ranked",
  ...
  },
  {
    ...
    buyingGuide: [
      { title: "Choose a starting point, not a required sequence", text: "The Robert Langdon novels can be read as standalones. Start with The Da Vinci Code for the most accessible entry; Angels & Demons was published first and makes a good follow-up if you want more of the series." },
