    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <section className="mt-12 rounded-[2rem] border border-slate-200 bg-white p-6">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-slate-700">
          If your picnic usually includes chilled food, the USDA&apos;s{' '}
          <a
            href="https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/food-safety-picnics-and-bbqs"
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold text-rose-700 underline underline-offset-2"
          >
            picnic and barbecue food safety guide
          </a>
          {' '}is a useful non-Amazon companion for packing smarter in warm weather.
        </p>
      </section>
